       ...
       <div className="container mx-auto px-6 relative">
        ...
        <div className="grid md:grid-cols-3 gap-8 items-end">
          {pricingPlans.map((plan, index) => (
            <div key={index} className={`relative bg-gray-900 rounded-lg p-6 shadow-lg border-2 transition-all duration-300 ${plan.bestValue ? 'border-yellow-400 transform md:scale-110' : 'border-gray-700'}`}>
