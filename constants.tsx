...
const RockIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
...
const SpoonIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6" {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M12.963 2.286a.75.75 0 0 0-1.071 1.052A11.203 11.203 0 0 1 11.25 10.5C8.953 10.5 7.14 8.687 7.14 6.39a.75.75 0 0 0-1.48-.224c-.027.05-.054.1-.08.152A5.996 5.996 0 0 0 6 11.25c0 3.313 2.686 6 6 6s6-2.687 6-6c0-2.02-.994-3.822-2.52-4.938a.75.75 0 1 0-.918 1.187A4.492 4.492 0 0 1 16.5 11.25c0 2.485-2.015 4.5-4.5 4.5s-4.5-2.015-4.5-4.5c0-1.57.81-2.944 2.037-3.791a.75.75 0 0 0-.342-1.383A5.994 5.994 0 0 0 7.5 11.25c0 .765.15 1.5.424 2.179a.75.75 0 1 0 1.41-.458A4.475 4.475 0 0 1 9 11.25c0-1.32.784-2.43 1.871-2.848a.75.75 0 0 0 .31-1.432Z" />
    </svg>
);
const CalendarIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6" {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 0 1 2.25-2.25h13.5A2.25 2.25 0 0 1 21 7.5v11.25m-18 0A2.25 2.25 0 0 0 5.25 21h13.5A2.25 2.25 0 0 0 21 18.75m-18 0h18M12 11.25h.008v.008H12v-.008Zm0 3.75h.008v.008H12v-.008Zm-3.75-3.75h.008v.008H8.25v-.008Zm0 3.75h.008v.008H8.25v-.008Zm-3.75-3.75h.008v.008H4.5v-.008Zm0 3.75h.008v.008H4.5v-.008Zm11.25-3.75h.008v.008H15.75v-.008Zm0 3.75h.008v.008H15.75v-.008Z" />
    </svg>
);
...
const HormoneIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6" {...props}>
      ...
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 18a.375.375 0 0 0 .375-.375V12.375h3.375a.375.375 0 0 0 0-.75h-3.375V8.625a.375.375 0 0 0-.75 0v3h-3.375a.375.375 0 0 0 0 .75h3.375v5.25A.375.375 0 0 0 12 18Z" />
    </svg>
);

const BloodIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M15.91 15.91a.75.75 0 0 1-1.06 0l-1.06-1.061a.75.75 0 0 1 1.06-1.06l1.06 1.06a.75.75 0 0 1 0 1.061Zm-4.95-4.95a.75.75 0 0 1 0 1.06L9.9 13.06a.75.75 0 0 1-1.06-1.06l1.06-1.06a.75.75 0 0 1 1.06 0Z" />
    </svg>
);
